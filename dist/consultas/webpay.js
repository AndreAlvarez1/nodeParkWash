...
router.post('/initInscription', function (req, res) {
    console.log('initInscription');
    const transaction = new Transbank.Webpay(Transbank.Configuration.forTestingWebpayOneClickNormal()).getOneClickTransaction();
});
